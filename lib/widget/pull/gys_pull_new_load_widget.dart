...
import 'package:flutter_git/widget/pull/gsy_flare_pull_controller.dart';
import 'package:flutter_git/widget/pull/gsy_refresh_silver.dart' as IOS;
import 'package:flutter_git/widget/pull/custom_bouncing_scroll_physics.dart';
      ...
      child: new Container(
        ...
        child: FlareActor(
          //"static/file/Space-Demo.flr",
            "images/file/loading_world_now.flr",
...
class GSYPullLoadWidgetControl extends ChangeNotifier {
  ...
  set needHeader(value) {
    _needHeader = value;
//    GSYPullLoadWidgetControl的listener会发生回调
    notifyListeners();
  }
